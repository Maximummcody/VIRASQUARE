...
export function WorkspaceShell({ onEditProfile }: { onEditProfile: () => void }) {
  ...
  const libraryTabs: Array<{ id: LibraryWorkTab; label: string; count: number }> = [
    { id: "drafts", label: "Drafts", count: libraryWorkCount(libraryEntries, "drafts") },
    { id: "ready", label: "Ready to post", count: libraryWorkCount(libraryEntries, "ready") },
    { id: "posted", label: "Posted", count: libraryWorkCount(libraryEntries, "posted") },
    { id: "archived", label: "Archived", count: libraryWorkCount(libraryEntries, "archived") },
  ];
