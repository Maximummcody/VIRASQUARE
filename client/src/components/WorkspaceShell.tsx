...
import { filterLibraryWork, getLibraryWorkTab, libraryWorkCount, searchLibraryWork, type LibraryWorkTab } from "@/lib/libraryWork";
...
export function WorkspaceShell({ onEditProfile }: { onEditProfile: () => void }) {
  ...
  const visibleLibraryEntries = librarySearch.trim() ? searchLibraryWork(activeLibraryEntries, librarySearch) : filterLibraryWork(libraryEntries, libraryTab);
